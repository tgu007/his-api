...
public class FeeDownLoadLineRespDto {
    private UUID uuid;
    ...
    public FeeListDto getFee() {
        return fee;
    }

    public void setFee(FeeListDto fee) {
        this.fee = fee;
    }
    ...
    public BigDecimal getInsuranceAmount()
    {
        ...
        if(this.getZfje() != null)
            totalSelfAmount = totalSelfAmount.add(this.getZfje());
        if(this.getZlje() != null)
            totalSelfAmount = totalSelfAmount.add(this.getZlje());
        return this.getJe().subtract(totalSelfAmount);
    }
}
