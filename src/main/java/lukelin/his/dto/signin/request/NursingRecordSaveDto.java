...
import lukelin.his.domain.entity.patient_sign_in.NursingRecord;
...
public class NursingRecordSaveDto {
    private UUID uuid;
    ...
    public NursingRecord toEntity() {
        NursingRecord nursingRecord = new NursingRecord();
        BeanUtils.copyProperties(this, nursingRecord);
        nursingRecord.setPatientSignIn(new PatientSignIn(this.getPatientSignInId()));
