...
import lukelin.his.domain.entity.patient_sign_in.TempRecord;
import lukelin.his.domain.enums.PatientSignIn.UrineVolume;

import java.util.Date;
import java.util.UUID;

public class TempRecordSaveDto {
    private UUID uuid;
    ...
    public TempRecord toEntity() {
        TempRecord tempRecord = new TempRecord();
        BeanUtils.copyProperties(this, tempRecord);
        tempRecord.setPatientSignIn(new PatientSignIn(this.getPatientSignInId()));
        return tempRecord;
    }
}
